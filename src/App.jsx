...
import { ChevronLeft, ChevronRight, Menu, X, Phone, Mail, MapPin, Building, Wrench, HardHat, Lightbulb, Target, Eye, Award, Factory, Users, TrendingUp, Calendar, Send, CheckCheckIcon, CheckCircle, User, Hammer, Globe } from 'lucide-react';
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                        ...
                        <AnimatedSection variants={fromRightVariant}>
                            ...
                            <p className="lg:text-gray-100 font-semibold md:text-gray-600 mb-4">Mohanty Construction Corp. Pvt. Ltd., is Registered Under MSME (ISO 9001:2015 CERTIFIED FIRM) and has been a cornerstone in engineering construction. <br /> <br />
                            ...
                            <p className="text-gray-600 md:text-gray-100">Our reputation is built on a foundation of quality, safety, and timely execution. We are dedicated to being a complete solution provider in fabrication, erection, and commissioning, including turnkey projects.</p>
                        </AnimatedSection>
                    </div>
...
const ServicesPage = () => {
    const services = [
        ...
        { icon: <Hammer size={40} />, title: "Construction Management", description: "Overseeing projects from inception to completion, ensuring quality and efficiency." },
...
const ProjectsPage = () => {
    ...
    const mohantyProjects = [];


    return (
        <PageWrapper>
            <section className="relative h-[40vh] md:h-50 w-full mb-12" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1514069709437-f1c294e44e1a?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center text-center px-4">
                    <motion.h1
                        className="text-2xl md:text-4xl font-bold text-white mb-4"
                        variants={heroTextVariant}
            ...
            {/* Render the two distinct project sections */}
            {renderProjectsGrid(mohantyConstruction, 'Mohanty Construction Corp.', 'Mohanty Construction Corporation has long-standing expertise in delivering large-scale civil and infrastructure projects, Mohanty Projects Private Limited has been structured to focus on technologically intensive and mission-critical railway works. This includes design, installation, testing, commissioning, and maintenance of signaling and telecommunication systems for the Indian Railways.')}
        </PageWrapper>
    );
};
                        ...
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                ...
                                <motion.div variants={fromRightVariant} initial="hidden" animate="visible" className="space-y-6 bg-white rounded-lg border p-12 ">
                                    <div className="flex items-start"><MapPin className="text-blue-600 mt-1 mr-4 flex-shrink-0" /><div><h4 className="font-semibold">Address</h4><p>Ground Floor, Chandranil Apartment, Near Tirpude College,
                                        Sadar, Nagpur – 440001</p></div></div>
                                    <div className="flex items-start"><Mail className="text-blue-600 mt-1 mr-4 flex-shrink-0" /><div><h4 className="font-semibold">Email</h4><p>mohantyconstructioncorporation@gmail.com</p></div></div>
                                    <div className="flex items-start"><Phone className="text-blue-600 mt-1 mr-4 flex-shrink-0" /><div><h4 className="font-semibold">Phone</h4><p>+91 9923365525</p></div></div>
                                    <div className="flex items-start"><Globe className="text-blue-600 mt-1 mr-4 flex-shrink-0" /><div><h4 className="font-semibold">Website</h4><p> https://www.indiamart.com/mohantyconstructioncorporation/</p></div></div>
...
const ServicesSectionPreview = () => {
    const services = [
        ...
        { icon: <Hammer size={40} />, title: "Construction Management" },
    ];
    return (
